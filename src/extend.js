...
Function.prototype.extends = function (parent) {
    var prototype = parent.prototype, create = Object.create(prototype);
...
String.prototype.toDate = function () {
    var data = this.toString().split(' '),
            ...
            timeStr = data[1] ? data[1].split(':') : [0, 0, 0], date;

    date = new Date(dateStr[0], dateStr[1] - 1, dateStr[2], timeStr[0], timeStr[1], timeStr[2]);
    return date;
};

Date.prototype.hash = function () {
    var date = this;
    return [date.getYear(), date.getMonth(), date.getDay(), date.getHours(), date.getMinutes(), date.getSeconds()].join('');
};
...
Object.is = function(x) {
    return typeof x === 'object' && !(x instanceof Array) && (x instanceof Object);
}
